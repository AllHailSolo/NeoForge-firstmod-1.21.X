...
public class ModArmorMaterials {
    public static final DeferredRegister<ArmorMaterial> ARMOR_MATERIALS = DeferredRegister.create(Registries.ARMOR_MATERIAL, FirstMod.MOD_ID);
    ...
    public static final Holder<ArmorMaterial> BLACK_OPAL =
            ARMOR_MATERIALS.register("black_opal", () -> new ArmorMaterial(
                    ...
                    List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(FirstMod.MOD_ID, "black_opal"))),
                    0, 0));
